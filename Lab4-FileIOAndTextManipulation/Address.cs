...
namespace Lab4_FileIOAndTextManipulation
{
    public class Address
    {
        ...
        /*
         * The secondary constructor for the Address class.
         * Used if you want to include county.
         * 
         * Date Created: 02/17/2022
         * @param number, ZipCode (int)
         * @param county, city, state (string)
         */
        public Address(string address, string county, string city, string state, string zipCode)
        {
            //We will need to format address to get number and street.
            string[] addressParts = address.Split(' ');
